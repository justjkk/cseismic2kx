...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Participant.groupby_hack'
        db.add_column('participantsprofile_participant', 'groupby_hack', self.gf('django.db.models.fields.CharField')(default='Online Registrants', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Participant.groupby_hack'
        db.delete_column('participantsprofile_participant', 'groupby_hack')
    ...
    models = {
        ...
        'participantsprofile.participant': {
            ...
            'email_verified': ('django.db.models.fields.CharField', [], {'default': "'No'", 'max_length': '3'}),
            'events': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['events.Event']", 'null': 'True', 'blank': 'True'}),
            'groupby_hack': ('django.db.models.fields.CharField', [], {'default': "'Online Registrants'", 'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
