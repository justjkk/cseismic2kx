...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Participant.email_verified'
        db.add_column('participantsprofile_participant', 'email_verified', self.gf('django.db.models.fields.CharField')(default='No', max_length=3), keep_default=False)
        Participant = orm['participantsprofile.Participant']
        for p in Participant.objects.all():
            if p.user.user.is_active:
                p.email_verified = 'Yes'
            else:
                p.email_verified = 'No'
            p.save()
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Participant.email_verified'
        db.delete_column('participantsprofile_participant', 'email_verified')
