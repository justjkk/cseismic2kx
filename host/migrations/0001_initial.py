...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('host_coordinator', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('academic_year', self.gf('django.db.models.fields.IntegerField')()),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='coordinators', null=True, to=orm['events.Event'])),
            ('contact_phone', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('host', ['Coordinator'])


    def backwards(self, orm):
        
        # Deleting model 'Coordinator'
        db.delete_table('host_coordinator')
